		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSwitch_StatementAccess().getAlternatives_8(), "rule__Switch_Statement__Alternatives_8");
					...
					put(grammarAccess.getSwitch_StatementAccess().getGroup_7(), "rule__Switch_Statement__Group_7__0");
					put(grammarAccess.getSwitch_StatementAccess().getGroup_8_0(), "rule__Switch_Statement__Group_8_0__0");
					...
					put(grammarAccess.getLiteral_ExpressionAccess().getExpAssignment_0_0(), "rule__Literal_Expression__ExpAssignment_0_0");
					put(grammarAccess.getLiteral_ExpressionAccess().getExp1Assignment_0_1(), "rule__Literal_Expression__Exp1Assignment_0_1");
					...
					put(grammarAccess.getStatementAccess().getStatementBlockAssignment_8_0(), "rule__Statement__StatementBlockAssignment_8_0");
					...
					put(grammarAccess.getStatementAccess().getVariableDeclaratorAssignment_14_0(), "rule__Statement__VariableDeclaratorAssignment_14_0");
					put(grammarAccess.getSwitch_StatementAccess().getSw_expAssignment_3(), "rule__Switch_Statement__Sw_expAssignment_3");
					put(grammarAccess.getSwitch_StatementAccess().getCase_expAssignment_6_0_1(), "rule__Switch_Statement__Case_expAssignment_6_0_1");
					put(grammarAccess.getSwitch_StatementAccess().getStatementsAssignment_6_1(), "rule__Switch_Statement__StatementsAssignment_6_1");
					put(grammarAccess.getSwitch_StatementAccess().getCase_expAssignment_8_0_1(), "rule__Switch_Statement__Case_expAssignment_8_0_1");
					put(grammarAccess.getSwitch_StatementAccess().getStatementsAssignment_8_1(), "rule__Switch_Statement__StatementsAssignment_8_1");
					put(grammarAccess.getFor_StatementAccess().getVariableAssignment_2_0(), "rule__For_Statement__VariableAssignment_2_0");
					put(grammarAccess.getFor_StatementAccess().getExpressionAssignment_2_1_0(), "rule__For_Statement__ExpressionAssignment_2_1_0");
					put(grammarAccess.getFor_StatementAccess().getPvAssignment_2_2(), "rule__For_Statement__PvAssignment_2_2");
