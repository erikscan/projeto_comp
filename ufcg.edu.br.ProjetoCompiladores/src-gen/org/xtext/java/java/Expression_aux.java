 ...
 *   <li>{@link org.xtext.java.java.Expression_aux#getExpressionComma <em>Expression Comma</em>}</li>
...
public interface Expression_aux extends EObject
{
  ...
  /**
   * Sets the value of the '{@link org.xtext.java.java.Expression_aux#getArgList <em>Arg List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the value of the '<em><b>Expression Comma</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Expression Comma</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Expression Comma</em>' containment reference.
   * @see #setExpressionComma(Expression)
   * @see org.xtext.java.java.JavaPackage#getExpression_aux_ExpressionComma()
   * @model containment="true"
   * @generated
   */
  Expression getExpressionComma();

  /**
   * Sets the value of the '{@link org.xtext.java.java.Expression_aux#getExpressionComma <em>Expression Comma</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Expression Comma</em>' containment reference.
   * @see #getExpressionComma()
   * @generated
   */
  void setExpressionComma(Expression value);
