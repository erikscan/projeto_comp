 ...
 *   <li>{@link org.xtext.java.java.impl.StatementImpl#getStatementBlock <em>Statement Block</em>}</li>
...
public class StatementImpl extends MinimalEObjectImpl.Container implements Statement
{
  ...
  public NotificationChain basicSetStatementBlock(Statement_block newStatementBlock, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.STATEMENT__STATEMENT_BLOCK, oldStatementBlock, newStatementBlock);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setStatementBlock(Statement_block newStatementBlock)
  {
    if (newStatementBlock != statementBlock)
    {
      ...
      if (statementBlock != null)
        msgs = ((InternalEObject)statementBlock).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.STATEMENT__STATEMENT_BLOCK, null, msgs);
      if (newStatementBlock != null)
        msgs = ((InternalEObject)newStatementBlock).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.STATEMENT__STATEMENT_BLOCK, null, msgs);
      msgs = basicSetStatementBlock(newStatementBlock, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.STATEMENT__STATEMENT_BLOCK, newStatementBlock, newStatementBlock));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case JavaPackage.STATEMENT__STATEMENT_BLOCK:
