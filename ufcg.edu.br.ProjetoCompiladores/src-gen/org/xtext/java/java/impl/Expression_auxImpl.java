 ...
 *   <li>{@link org.xtext.java.java.impl.Expression_auxImpl#getExpressionComma <em>Expression Comma</em>}</li>
...
public class Expression_auxImpl extends MinimalEObjectImpl.Container implements Expression_aux
{
  ...
  public NotificationChain basicSetArgList(Arg_List newArgList, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.EXPRESSION_AUX__ARG_LIST, oldArgList, newArgList);
  ...
  public void setArgList(Arg_List newArgList)
  {
    if (newArgList != argList)
    {
      ...
      if (argList != null)
        msgs = ((InternalEObject)argList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.EXPRESSION_AUX__ARG_LIST, null, msgs);
      if (newArgList != null)
        msgs = ((InternalEObject)newArgList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.EXPRESSION_AUX__ARG_LIST, null, msgs);
      msgs = basicSetArgList(newArgList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.EXPRESSION_AUX__ARG_LIST, newArgList, newArgList));
  }
  ...
  public NotificationChain basicSetExpressionComma(Expression newExpressionComma, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.EXPRESSION_AUX__EXPRESSION_COMMA, oldExpressionComma, newExpressionComma);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExpressionComma(Expression newExpressionComma)
  {
    if (newExpressionComma != expressionComma)
    {
      ...
      if (expressionComma != null)
        msgs = ((InternalEObject)expressionComma).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.EXPRESSION_AUX__EXPRESSION_COMMA, null, msgs);
      if (newExpressionComma != null)
        msgs = ((InternalEObject)newExpressionComma).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.EXPRESSION_AUX__EXPRESSION_COMMA, null, msgs);
      msgs = basicSetExpressionComma(newExpressionComma, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.EXPRESSION_AUX__EXPRESSION_COMMA, newExpressionComma, newExpressionComma));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case JavaPackage.EXPRESSION_AUX__EXPRESSION_COMMA:
