...
public interface JavaPackage extends EPackage
{
   ...
   * @ordered
   */
  int FLOAT_LITERAL_FEATURE_COUNT = 3;
   ...
   * @ordered
   */
  int STATEMENT__STATEMENT_BLOCK = 8;
   ...
   * @ordered
   */
  int STATEMENT__VARIABLE_DECLARATOR = 12;
  ...
  /**
   * The feature id for the '<em><b>Sw exp</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int SWITCH_STATEMENT__SW_EXP = 0;

  /**
   * The feature id for the '<em><b>Case exp</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int SWITCH_STATEMENT__CASE_EXP = 1;
  ...
  /**
   * Returns the meta object for the containment reference '{@link org.xtext.java.java.Expression_aux#getArgList <em>Arg List</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the containment reference '{@link org.xtext.java.java.Expression_aux#getExpressionComma <em>Expression Comma</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Expression Comma</em>'.
   * @see org.xtext.java.java.Expression_aux#getExpressionComma()
   * @see #getExpression_aux()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference '{@link org.xtext.java.java.Statement#getStatementBlock <em>Statement Block</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Statement Block</em>'.
   * @see org.xtext.java.java.Statement#getStatementBlock()
   * @see #getStatement()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference '{@link org.xtext.java.java.Switch_Statement#getSw_exp <em>Sw exp</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Sw exp</em>'.
   * @see org.xtext.java.java.Switch_Statement#getSw_exp()
   * @see #getSwitch_Statement()
   * @generated
   */
  EReference getSwitch_Statement_Sw_exp();

  /**
   * Returns the meta object for the containment reference list '{@link org.xtext.java.java.Switch_Statement#getCase_exp <em>Case exp</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Case exp</em>'.
   * @see org.xtext.java.java.Switch_Statement#getCase_exp()
   * @see #getSwitch_Statement()
   * @generated
   */
  EReference getSwitch_Statement_Case_exp();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '<em><b>Sw exp</b></em>' containment reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference SWITCH_STATEMENT__SW_EXP = eINSTANCE.getSwitch_Statement_Sw_exp();

    /**
     * The meta object literal for the '<em><b>Case exp</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference SWITCH_STATEMENT__CASE_EXP = eINSTANCE.getSwitch_Statement_Case_exp();
